...
require('lazy').setup({
  ...
  'sealemar/vtl',
  {
    ...
    config = function()
      ...
      vim.api.nvim_set_keymap('i', '<D-y>', 'copilot#Accept()', { expr = true, silent = true, noremap = false })
    end,
  },
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        preset = 'default',
        ['<D-y>'] = { 'accept', 'select_and_accept', 'fallback' },
        ['<D-n>'] = { 'select_next', 'fallback' },
        ['<D-e>'] = { 'select_prev', 'fallback' },
        ['<C-y>'] = {},
        ['<C-n>'] = {},
        ['<C-p>'] = {},
      },
...
vim.keymap.set('n', '<leader>e', '<cmd>Neotree reveal<cr>', { silent = true, desc = 'Open N[e]o Tree' })
...
-- velocity template file types
vim.api.nvim_create_autocmd({ 'BufRead', 'BufNewFile' }, {
  pattern = '*.vtl',
  callback = function() vim.bo.filetype = 'vm' end,
})
